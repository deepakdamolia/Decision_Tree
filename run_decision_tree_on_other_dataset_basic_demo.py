...
#%%PRUNING
dummy = input("Press Enter for Pruning")

def get_best_pruned_tree (D,L,K,X_val,Y_val):
    ...
    for i in range(L):
        ...
        for m in range(M):
            ...
            Ddash.leafify(n)  #make nth non-leaf node a leaf
...
Dbest = get_best_pruned_tree(tree,100,60,X_val,Y_val)
